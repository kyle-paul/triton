...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        output_config = pb_utils.get_output_config_by_name(model_config, "detection_postprocessing_output")
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            input_1 = pb_utils.get_input_tensor_by_name(request, "detection_postprocessing_input_1")
            input_2 = pb_utils.get_input_tensor_by_name(request, "detection_postprocessing_input_2")
            input_3 = pb_utils.get_input_tensor_by_name(request, "detection_postprocessing_input_3")

            scores = input_1.as_numpy().transpose(0, 3, 1, 2)
            geometry = input_2.as_numpy().transpose(0, 3, 1, 2)
            frame = np.squeeze(input_3.as_numpy(), axis=0)
            ...
            output = pb_utils.Tensor("detection_postprocessing_output", cropped_arr.astype(self.output_dtype))
