...
class TritonPythonModel:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            #     image = np.array(image.resize((640, 480), Image.BILINEAR))
            #     image = image - np.array([123.68, 103.94, 116.78]).reshape(1,1,3)
            ...
            blob = cv2.dnn.blobFromImage(np.array(image), 1.0, (640, 480), (123.68, 116.78, 103.94), False, False)
